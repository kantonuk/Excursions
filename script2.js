...
function getCardHTML(product) {
    return `
     <div class="my-card" style="background-color: antiquewhite; border-radius:20px; margin:1%;padding:2%;border:solid 2px black; ">
            <img style="width:100%;border-radius:20px;" src="${product.image}">
            <h5 class="text-my-card" style="font-size:150%">${product.title}</h5>
           ...
           <a style="margin-right:70%" href="${product.details}">Деталі</a>
...
getProducts().then(function (products) {
    let productsList = document.querySelector('.jorney')
    if (productsList) {
    ...
    let buyButtons = document.querySelectorAll('.jorney .cart');
